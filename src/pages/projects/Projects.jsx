...
import pr0 from './img/notes.png'
import pr1 from './img/weather.png'
import pr2 from './img/calc.png'
import pr3 from './img/pomodoro.png'
import pr4 from './img/drummachine.png'
import pr5 from './img/markup.png'
import pr6 from './img/quotemachine.png'
import pr7 from './img/bob.png'
import pr8 from './img/battleship.png'
import pr9 from './img/trivia.png'
import pr10 from './img/bg_genertor.png'
import pr11 from './img/s-list.png'
import pr12 from './img/weryk.png'
import pr13 from './img/landing.png'
import pr14 from './img/scratch.png'
import pr15 from './img/moriak.png'
import Noproject from '../../components/Noproject'
const projectssrc = [pr0, pr1, pr2, pr3, pr4, pr5, pr6, pr7, pr8, pr9, pr10, pr11, pr12, pr13, pr14, pr15]
const classes = [
